...
import logo from '../src/assets/apprentice_8920511.png'
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              <div className="flex-shrink-0">
                <img className="w-10 h-10" src={logo} alt="Student Management System" />
              </div>
              ...
              <div className="px-2 pt-2 pb-3 space-y-1">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`flex items-center space-x-3 w-full text-left px-4 py-3 rounded-lg text-base font-medium transition-all duration-200 ${
                      activeTab === tab.id
        ...
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              <img className="w-6 h-6" src={logo} alt="EduManage" />
              <span className="text-sm font-medium text-gray-700">EduManage System</span>
            </div>
